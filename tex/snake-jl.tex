...
\section{Basics}
\b{Snake} is a relatively simple system which adds elements of its key to the plaintext, with the addition being modulo some fixed base. Let the key be denoted by $f$, for instance, with base = $3$, we might have $f = 021022012102$. Then $f[0] = 0, f[1] =2 , f[2] = 1,...$  
